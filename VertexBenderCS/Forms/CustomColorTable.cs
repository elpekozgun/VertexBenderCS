...
namespace VertexBenderCS
{
    public class CustomColorTable : ProfessionalColorTable
    {
        ...
        public override Color ButtonSelectedGradientBegin => base.ButtonSelectedGradientBegin;

        public override Color ButtonSelectedGradientMiddle => base.ButtonSelectedGradientMiddle;

        public override Color ButtonSelectedGradientEnd => base.ButtonSelectedGradientEnd;
        ...
        public override Color CheckBackground => base.CheckBackground;

        public override Color CheckSelectedBackground => base.CheckSelectedBackground;
        ...
        public override Color ImageMarginRevealedGradientMiddle => base.ImageMarginRevealedGradientMiddle;

        public override Color ImageMarginRevealedGradientEnd => base.ImageMarginRevealedGradientEnd;

        public override Color MenuStripGradientBegin => base.MenuStripGradientBegin;

        public override Color MenuStripGradientEnd => base.MenuStripGradientEnd;

        public override Color MenuItemSelected => base.MenuItemSelected;

        public override Color MenuItemBorder => Color.MediumAquamarine;

        public override Color MenuBorder => Color.MediumAquamarine;

        public override Color MenuItemSelectedGradientBegin => base.MenuItemSelectedGradientBegin;

        public override Color MenuItemSelectedGradientEnd => base.MenuItemSelectedGradientEnd;
        ...
        public override Color StatusStripGradientEnd => base.StatusStripGradientEnd;

        public override Color ToolStripBorder => base.ToolStripBorder;

        public override Color ToolStripDropDownBackground => Color.FromArgb(255, 50, 50, 50);
        ...
        public override Color OverflowButtonGradientBegin => base.OverflowButtonGradientBegin;

        public override Color OverflowButtonGradientMiddle => base.OverflowButtonGradientMiddle;

        public override Color OverflowButtonGradientEnd => base.OverflowButtonGradientEnd;
    }
